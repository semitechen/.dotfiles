...
-- Lowercase Polish Characters (Alt + letter in Insert Mode)
vim.keymap.set('i', '<A-a>', 'ą')
vim.keymap.set('i', '<A-c>', 'ć')
vim.keymap.set('i', '<A-e>', 'ę')
vim.keymap.set('i', '<A-l>', 'ł')
vim.keymap.set('i', '<A-n>', 'ń')
vim.keymap.set('i', '<A-o>', 'ó')
vim.keymap.set('i', '<A-s>', 'ś')
vim.keymap.set('i', '<A-x>', 'ź')
vim.keymap.set('i', '<A-z>', 'ż')

-- Uppercase Polish Characters (Alt + Shift + letter in Insert Mode)
vim.keymap.set('i', '<A-A>', 'Ą')
vim.keymap.set('i', '<A-C>', 'Ć')
vim.keymap.set('i', '<A-E>', 'Ę')
vim.keymap.set('i', '<A-L>', 'Ł')
